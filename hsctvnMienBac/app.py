        ...
        for item in items:
            ...
            if div:
                ...
                if addr_match:
                    ...
                    province = self.extract_province(full_address)
        ...
        try:
            ...
            for i, company in enumerate(companies, 1):
                df_data.append({
                    ...
                    'Tỉnh/Thành phố': company['address'],
    ...
    def scrape(self, area=None, month=None, from_page=None, to_page=None, get_phones=True, start_url=None):
        ...
        try:
            ...
            if requested_pages > MAX_PAGES:
                ...
                self.log(f'Giới hạn tối đa {MAX_PAGES} trang mỗi lần. Tự động điều chỉnh đến trang {to_page}.',
                         'warning')
...
def download_csv():
    ...
    writer.writerow(['STT', 'Tên công ty', 'Mã số thuế', 'Số điện thoại', 'Tỉnh/Thành phố'])
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Công cụ lấy thông tin công ty và số điện thoại - Chỉ lấy tỉnh/thành phố</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="section results-section" id="resultsSection">
                ...
                <div class="search-box">
                    <input type="text" id="searchInput" placeholder="🔍 Tìm kiếm theo tên, tỉnh/thành phố, số điện thoại..." onkeyup="filterResults()">
                </div>
